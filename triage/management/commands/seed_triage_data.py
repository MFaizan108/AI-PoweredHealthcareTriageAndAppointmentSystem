    ...
    def handle(self, *args, **options):
        ...
        symptoms = [
            ...
            (
                ...
                C.RESPIRATORY,
                "difficulty breathing, shortness of breath, breathless, can't breathe, cant breathe",
                6,
                True,
                "Emergency",
            ),
            ...
            (
                ...
                C.NEUROLOGICAL,
                "slurred speech, facial droop, one side weakness, face drooping",
                6,
                True,
                "Emergency",
            ),
            ...
            (
                "Suicidal Thoughts",
                C.MENTAL_HEALTH,
                "suicidal, want to die, self harm, self-harm, kill myself",
                6,
                True,
                "Mental Health",
            ),
            ...
            (
                "Fracture/Injury",
                C.MUSCULOSKELETAL,
                "fracture, broken bone, severe injury, deformed limb",
                5,
                False,
                "Orthopedics",
            ),
        ...
        guidance = [
            (
                TriageAssessment.Urgency.EMERGENCY,
